...
void SD_DeInit(void)
{
  ...
  GPIO_PinAFConfig(SD_SPI_SCK_GPIO_PORT, SD_SPI_SCK_PinSource, SD_SPI_AF);
  GPIO_PinAFConfig(SD_SPI_MISO_GPIO_PORT, SD_SPI_MISO_PinSource, SD_SPI_AF);
...
static void GPIO_Configuration(void)
{
  ...
  RCC_AHB1PeriphClockCmd(SD_CS_GPIO_CLK | SD_SPI_MOSI_GPIO_CLK |
                             SD_SPI_MISO_GPIO_CLK | SD_SPI_SCK_GPIO_CLK,
                         ENABLE);
  ...
  GPIO_PinAFConfig(SD_SPI_SCK_GPIO_PORT, SD_SPI_SCK_PinSource, SD_SPI_AF);
  GPIO_PinAFConfig(SD_SPI_MISO_GPIO_PORT, SD_SPI_MISO_PinSource, SD_SPI_AF);
  GPIO_PinAFConfig(SD_SPI_MOSI_GPIO_PORT, SD_SPI_MOSI_PinSource, SD_SPI_AF);
